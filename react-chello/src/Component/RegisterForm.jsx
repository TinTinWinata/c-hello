    ...
    <div className="w-full max-w-xs" id="registerForm">
      ...
      >
        ...
        <div className="flex flex-col items-center justify-between">
          <button
            type="submit"
            className="mb-2 w-full bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline"
          >
            Sign Up
          </button>
          <p className="text-x text-gray-400">Or you can register with</p>
          <StyledFirebaseAuth
            className=""
            uiConfig={uiConfig}
