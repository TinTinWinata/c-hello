function Navbar() {
  ...
  <a href="https://google.com" class="flex items-center">
      <span class="self-center text-xl font-semibold whitespace-nowrap dark:text-white">CHello</span>
  </a>
  <div class="flex md:order-2">
    ...
    <a href="/register">
    <button class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded ml-3">Register</button>
    </a>
